...
l100n = {
	locale: "en",                   // Current locale codename
	default_locale: "en",           // Default (fallback) locale codename
    ...
    localize_page: function(page, custom_locale, no_always) {
        ...
        for (var string_id in strings) {
            ...
            if (strings[string_id].attr == undefined){
                $(string.selector).html(l10n_string);
            } else {
                $(string.selector).attr(strings[string_id].attr, l10n_string);
            }
